...
public class RememberFragment extends Fragment {
     ...
     * @return A new instance of fragment RememberFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_start_remember, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button nextButton = getView().findViewById(R.id.remember_send_button);
